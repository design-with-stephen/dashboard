  ...
  <div class="dashboard-container">
          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active-page"><a href="applications_viewphpl" >View Job Application</a></li>
    ...
    <main class="main_container">
      ...
      <section class="tabs">
        ...
        <button class="tab-btn active"> <?PHP echo '<a href="applications_view.php">View Applications</a>';?></button>
      </section>
