...
if (!isset($_SESSION['user_id'])) {
  header("Location: ../../functions/job_category.php");
  exit;
}
...
include("../../functions/job_category.php");
...
<head>
  ...
  <link rel="stylesheet" href="../css/util.css?v=3" />
</head>
  ...
  <div class="dashboard-container">
          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="#">Add Job Category</a></li>
                <li class="active-page">
                  <a href="jobType.php">Add Application Mode</a>
                </li>
              </ul>
            </li>
    ...
    <main class="main_container">
      ...
      <section class="tabs">
        ...
        <button class="tab-btn active"> <?PHP echo '<a href="add_applicationMode.php">Add Application Mode</a>'; ?></button>
              ...
              <form action="" class="mainForm" method="POST">
                <div class="field-container">
                  <div class="input-controller">
                    ...
                    <input type="text" class="input" name="jobMode" placeholder="Enter Job Application method"/>
                  </div>
                </div>
